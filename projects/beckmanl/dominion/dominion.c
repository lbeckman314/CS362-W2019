...
int myAdventurer(int drawntreasure, int currentPlayer, int temphand[], struct gameState *state)
{
    ...
    while(drawntreasure<2){
        ...
        // BUG: copper is not counted toward drawntreasure
...
int myCouncil_room(int currentPlayer, int handPos, struct gameState *state)
{
    int i;
    //+4 Cards
    for (i = 0; i < 4; i++)
...
int myFeast(int currentPlayer, int temphand[], struct gameState *state, int choice1)
{
    int i;
    int x;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  {
      case adventurer:
          myAdventurer(drawntreasure, currentPlayer, temphand, state);

      case council_room:
          myCouncil_room(currentPlayer, handPos, state);
