...
int play_mine ( int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
			return play_adventurer(currentPlayer, temphand, state);




    case council_room:
             return play_council(currentPlayer, handPos, state);
    ...
    case mine:
	return play_mine ( currentPlayer, choice1, choice2, state, handPos);
    ...
    case smithy:
	return play_smithy(currentPlayer, handPos, state);




    case village:
     return play_village(currentPlayer, handPos, state);
